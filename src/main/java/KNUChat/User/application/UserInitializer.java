...
public class UserInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        userService.createUser(new UserCreateRequest("kim111@gmail.com"));
        request = new UserProfileCreateRequest(
                new UserDto(1L, "김이나", "FEMALE", "kim111@gmail.com"),
        ...
        userService.createUser(new UserCreateRequest("park2@gmail.com"));
        request = new UserProfileCreateRequest(
                new UserDto(2L, "박진수", "MALE", "park2@gmail.com"),
        ...
        userService.createUser(new UserCreateRequest("lee321@gmail.com"));
        request = new UserProfileCreateRequest(
                new UserDto(3L, "이영호", "MALE", "lee321@gmail.com"),
        ...
        userService.createUser(new UserCreateRequest("jung4@gmail.com"));
        request = new UserProfileCreateRequest(
                new UserDto(4L, "정미경", "FEMALE", "jung4@gmail.com"),
        ...
        userService.createUser(new UserCreateRequest("hong5@gmail.com"));
        request = new UserProfileCreateRequest(
                new UserDto(5L, "홍길동", "MALE", "hong5@gmail.com"),
        ...
        userService.createUser(new UserCreateRequest("lee6@gmail.com"));
        request = new UserProfileCreateRequest(
                new UserDto(6L, "이지영", "FEMALE", "lee6@gmail.com"),
        ...
        userService.createUser(new UserCreateRequest("kim7@gmail.com"));
        request = new UserProfileCreateRequest(
                new UserDto(7L, "김철수", "MALE", "kim7@gmail.com"),
        ...
        userService.createUser(new UserCreateRequest("lee8@gmail.com"));
        request = new UserProfileCreateRequest(
                new UserDto(8L, "이나영", "FEMALE", "lee8@gmail.com"),
        ...
        userService.createUser(new UserCreateRequest("jung9@gmail.com"));
        request = new UserProfileCreateRequest(
                new UserDto(9L, "정호진", "MALE", "jung9@gmail.com"),
        ...
        userService.createUser(new UserCreateRequest("lee10@gmail.com"));
        request = new UserProfileCreateRequest(
                new UserDto(10L, "이영자", "FEMALE", "lee10@gmail.com"),
        ...
        userService.createUser(new UserCreateRequest("lee88@gmail.com"));
        request = new UserProfileCreateRequest(
                new UserDto(11L, "이영희", "FEMALE", "lee88@gmail.com"),
        ...
        userService.createUser(new UserCreateRequest("kim123@gmail.com"));
        request = new UserProfileCreateRequest(
                new UserDto(12L, "김철수", "MALE", "kim123@gmail.com"),
        ...
        userService.createUser(new UserCreateRequest("lee66@gmail.com"));
        request = new UserProfileCreateRequest(
                new UserDto(13L, "이지은", "FEMALE", "lee66@gmail.com"),
        ...
        userService.createUser(new UserCreateRequest("kim53@gmail.com"));
        request = new UserProfileCreateRequest(
                new UserDto(14L, "김현수", "MALE", "kim53@gmail.com"),
        ...
        userService.createUser(new UserCreateRequest("jung8@gmail.com"));
        request = new UserProfileCreateRequest(
                new UserDto(15L, "정수진", "FEMALE", "jung8@gmail.com"),
        ...
        userService.createUser(new UserCreateRequest("park76@gmail.com"));
        request = new UserProfileCreateRequest(
                new UserDto(16L, "박지훈", "MALE", "park76@gmail.com"),
        ...
        userService.createUser(new UserCreateRequest("cho9@gmail.com"));
        request = new UserProfileCreateRequest(
                new UserDto(17L, "조은영", "FEMALE", "cho9@gmail.com"),
        ...
        userService.createUser(new UserCreateRequest("lee10@gmail.com"));
        request = new UserProfileCreateRequest(
                new UserDto(18L, "이민호", "MALE", "lee10@gmail.com"),
        ...
        userService.createUser(new UserCreateRequest("kim11@gmail.com"));
        request = new UserProfileCreateRequest(
                new UserDto(19L, "김나영", "FEMALE", "kim11@gmail.com"),
        ...
        userService.createUser(new UserCreateRequest("park12@gmail.com"));
        request = new UserProfileCreateRequest(
                new UserDto(20L, "박현진", "MALE", "park12@gmail.com"),
